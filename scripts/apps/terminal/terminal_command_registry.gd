...
const FSCommands = preload("res://scripts/apps/terminal/terminal_commands/fs_commands.gd")
const AppCommands = preload("res://scripts/apps/terminal/terminal_commands/app_commands.gd")
const HermesCommands = preload("res://scripts/apps/terminal/terminal_commands/hermes_commands.gd")
