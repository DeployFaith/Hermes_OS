...
const HermesAppLoader = preload("res://scripts/ui/hermes_ui/runtime/hermes_app_loader.gd")
const HermesAppInstance = preload("res://scripts/ui/hermes_ui/runtime/hermes_app_instance.gd")
const HermesAppController = preload("res://scripts/ui/hermes_ui/runtime/hermes_app_controller.gd")
const HermesStore = preload("res://scripts/ui/hermes_ui/bindings/hermes_store.gd")
...
const HermesControllerUI = preload("res://scripts/ui/hermes_ui/runtime/bridges/hermes_controller_ui.gd")
const HermesOSBridge = preload("res://scripts/ui/hermes_ui/runtime/bridges/hermes_os_bridge.gd")

const BUILTIN_STYLES := [
	"res://scripts/ui/hermes_ui/theme/dark.tokens.hss",
	"res://scripts/ui/hermes_ui/theme/components.hss",
	"res://scripts/ui/hermes_ui/theme/os_shell.hss"
]
