...
const HermesMarkupDocument = preload("res://scripts/ui/hermes_ui/markup/hermes_markup_document.gd")
const HermesMarkupNode = preload("res://scripts/ui/hermes_ui/markup/hermes_markup_node.gd")
