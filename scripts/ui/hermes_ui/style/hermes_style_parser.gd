...
const HermesStyleSheet = preload("res://scripts/ui/hermes_ui/style/hermes_style_sheet.gd")
const HermesStyleRule = preload("res://scripts/ui/hermes_ui/style/hermes_style_rule.gd")
const HermesStyleDeclaration = preload("res://scripts/ui/hermes_ui/style/hermes_style_declaration.gd")
const HermesStyleValue = preload("res://scripts/ui/hermes_ui/style/hermes_style_value.gd")
